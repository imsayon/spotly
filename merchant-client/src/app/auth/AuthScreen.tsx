...
function safeReturn(value: string | null) {
  try {
    const url = new URL(value || "/dashboard", "https://spotly.invalid");
    if (
      url.origin !== "https://spotly.invalid" ||
      ![
        "/dashboard",
        "/dashboard/outlets",
        "/dashboard/outlets/detail",
        "/dashboard/queue",
        "/dashboard/inventory",
        "/dashboard/analytics",
        "/dashboard/business",
    ...
    () =>
      ({
        "sign-in": [
          ...
          "Sign in to operate your queue.",
        ],
        "sign-up": [
          "Open your workspace",
          "Create a merchant account and add an outlet.",
        ],
        reset: [
          "Reset your password",
        ...
        callback: [
          "Finishing sign-in",
          "One moment while we return you to the workspace.",
        ],
    ...
    return (
      <AuthFrame title={copy[mode][0]} subtitle={copy[mode][1]}>
        <form onSubmit={submit} className="auth-page-form">
          ...
          <button className="merchant-button" disabled={busy}>
  ...
  return (
    <main className="auth-page">
      <div className="auth-page-brand">
        ...
        <span>spotly. / business</span>
      </div>
      <section className="merchant-card auth-page-card">
        <div

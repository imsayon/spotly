...
export default function ConsumerProfile() {
	const { user, profile, signOut, updateProfile, fetchProfile } =
		useAuthStore()
	...
	const uniqueMerchants = new Set(
		history.map((h) => h.merchantName).filter(Boolean),
	).size
			...
			<div style={{ textAlign: "center", marginBottom: 28 }}>
				<div
					style={{
						...
						fontWeight: 900,
						color: "#000",
						boxShadow: "0 0 0 6px rgba(245,196,24,.15)",
					}}
				>
				...
				>
					<span style={s.badge("yellow") as React.CSSProperties}>
						Consumer
					</span>
						...
						<div style={{ display: "flex", gap: 10, marginTop: 8 }}>
							<button
								...
								style={{
									...
									border: "none",
									background:
										"linear-gradient(135deg,#f5c418,#ff6316)",
									color: "#000",
									fontWeight: 800,
									cursor: "pointer",
					...
					>
						<div
							style={{
								...
								fontSize: 22,
								fontWeight: 800,
								...(s.gradCText as React.CSSProperties),
								marginBottom: 4,
							}}
						>
							{st.n}
				...
				history.map((h) => (
					...
					>
						...
						<div style={{ flex: 1 }}>
							...
							>
								{h.merchantName || h.outletName || "Outlet"}
							</div>
							<div style={{ fontSize: 11, color: "var(--t3)" }}>
								{formatDate(h.joinedAt)} — Token #
								{h.tokenNumber}
							</div>
						</div>
						<span

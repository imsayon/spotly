		...
		>
			...
			>
				...
				<div style={{ textAlign: "center", marginBottom: 32 }}>
					...
					>
						Sign in with Google or email to continue to
						Spotly.
					</p>
				</div>
				...
				<div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18, color: "rgba(255,255,255,.35)", fontSize: 12, textTransform: "uppercase", letterSpacing: 1, fontWeight: 800 }}>
				...
				<button
					...
					>
						{mode === "sign-up"
							...
							: "New to Spotly? Create an account"}
				</button>
